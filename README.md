...
- Soon to be implemented: Requirements (collision detection and handling, web dashboard showing all links and statistics), Authentication, Fun Stuff(filtering, charts, slug trends)
